...
def main_meteo():
    ...
    return climat_min,climat_max,climat_now,vitesse_du_vent,status_climat,volume_de_neige,volume_de_pluie,couverture_de_nuage,pourcentage_humidite,lever_du_soleil,coucher_du_soleil             #Retourne les valeurs obtenues
    #----------------------------------------------------------------------------------------------------------------------------
